...
export const metadata: Metadata = {
  title: `Terms of Service — ${siteConfig.name || siteConfig.title}`,
  ...
  return (
    <div className="static-page">
      <div className="static-page-inner">
        ...
        <section><h2>5. Intellectual Property</h2><p>All content is owned by or licensed to {siteConfig.name || siteConfig.title}.</p></section>
