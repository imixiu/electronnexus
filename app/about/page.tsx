...
export const metadata: Metadata = {
  title: `About Us — ${siteConfig.name || siteConfig.title}`,
  ...
  return (
    <div className="static-page">
      <div className="static-page-inner">
        <h1>About {siteConfig.name || siteConfig.title}</h1>
        <section>
          <h2>Our Mission</h2>
          <p>{siteConfig.name || siteConfig.title} is dedicated to providing expert content and guides. We help readers make informed decisions with reliable, well-researched information.</p>
        </section>
        <section>
          <h2>What We Do</h2>
