  ...
  ".next/server/edge/chunks/[root-of-the-server]__0az2aw2._.js"() {
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__0az2aw2._.js", 74398, (e, t, r) => {
      ...
      (() => {
        "use strict";
        let r2, n, i, a, o;
        var s, l, u, c, d, h, p, f, g, v, m, b, y, _, w, x, E = { 491: (e2, t2, r3) => {
        ...
        } }), y = O(475), Object.defineProperty(R, "TraceFlags", { enumerable: true, get: function() {
          return y.TraceFlags;
        } }), _ = O(98), Object.defineProperty(R, "createTraceState", { enumerable: true, get: function() {
        ...
        (() => {
          function t2(e3, t3) {
            ...
            for (var r3 = function(e4) {
              ...
              var m = h("CHAR"), b = h("NAME"), y = h("PATTERN");
              if (b || y) {
                var _ = m || "";
                -1 === a2.indexOf(_) && (d += _, _ = ""), d && (l.push(d), d = ""), l.push({ name: b || u++, prefix: _, suffix: "", pattern: y || v(_), modifier: h("MODIFIER") || "" });
                continue;
              }
              ...
              if (d && (l.push(d), d = ""), h("OPEN")) {
                ...
                p("CLOSE"), l.push({ name: x || (E ? u++ : ""), pattern: x && !E ? v(_) : E, prefix: _, suffix: C, modifier: h("MODIFIER") || "" });
                continue;
              }
              p("END");
            }
          ...
          function o(e3, t3, r3) {
            ...
            for (var n2 = r3.strict, o2 = void 0 !== n2 && n2, s2 = r3.start, l = r3.end, u = r3.encode, c = void 0 === u ? function(e4) {
              ...
              if ("string" == typeof m) g += i(c(m));
                ...
                var b = i(c(m.prefix)), y = i(c(m.suffix));
                if (m.pattern) if (t3 && t3.push(m), b || y) if ("+" === m.modifier || "*" === m.modifier) {
                  var _ = "*" === m.modifier ? "?" : "";
                  g += "(?:".concat(b, "((?:").concat(m.pattern, ")(?:").concat(y).concat(b, "(?:").concat(m.pattern, "))*)").concat(y, ")").concat(_);
                } else g += "(?:".concat(b, "(").concat(m.pattern, ")").concat(y, ")").concat(m.modifier);
                else {
                ...
                else g += "(?:".concat(b).concat(y, ")").concat(m.modifier);
              }
            }
      ...
      var n = { 226: function(t2, r2) {
        !function(n2) {
          "use strict";
          var i2 = "function", a2 = "undefined", o = "object", s = "string", l = "major", u = "model", c = "name", d = "type", h = "vendor", p = "version", f = "architecture", g = "console", v = "mobile", m = "tablet", b = "smarttv", y = "wearable", _ = "embedded", w = "Amazon", x = "Apple", E = "ASUS", C = "BlackBerry", O = "Browser", R = "Chrome", S = "Firefox", T = "Google", P = "Huawei", N = "Microsoft", A = "Motorola", k = "Opera", I = "Samsung", M = "Sharp", j = "Sony", D = "Xiaomi", L = "Zebra", U = "Facebook", $ = "Chromium OS", q = "Mac OS", B = function(e2, t3) {
            var r3 = {};
            ...
            return this.getBrowser = function() {
              ...
              var e3 = {};
              return e3[h] = void 0, e3[u] = void 0, e3[d] = void 0, z.call(e3, g2, y2.device), _2 && !e3[d] && b2 && b2.mobile && (e3[d] = v), _2 && "Macintosh" == e3[u] && r3 && typeof r3.standalone !== a2 && r3.maxTouchPoints && r3.maxTouchPoints > 2 && (e3[u] = "iPad", e3[d] = m), e3;
            }, this.getEngine = function() {
              var e3 = {};
              return e3[c] = void 0, e3[p] = void 0, z.call(e3, g2, y2.engine), e3;
            }, this.getOS = function() {
              var e3 = {};
              return e3[c] = void 0, e3[p] = void 0, z.call(e3, g2, y2.os), _2 && !e3[c] && b2 && "Unknown" != b2.platform && (e3[c] = b2.platform.replace(/chrome os/i, $).replace(/macos/i, q)), e3;
          ...
          if (J.VERSION = "1.0.35", J.BROWSER = H([c, p, l]), J.CPU = H([f]), J.DEVICE = H([u, h, d, g, v, b, m, y, _]), J.ENGINE = J.OS = H([c, p]), typeof r2 !== a2) t2.exports && (r2 = t2.exports = J), r2.UAParser = J;
      ...
      function O(e2, t2, r2) {
        ...
        return !function e3(t3, r3, n3, u3, c2) {
          ...
          v2 = 0;
          var m2 = "" === u3 ? "." : u3 + ":";
          if (a(t3)) for (var y2 = 0; y2 < t3.length; y2++) f2 = m2 + C(u3 = t3[y2], y2), v2 += e3(u3, r3, n3, f2, c2);
          else if ("function" == typeof (y2 = null === (p2 = t3) || "object" != typeof p2 ? null : "function" == typeof (p2 = b && p2[b] || p2["@@iterator"]) ? p2 : null)) for (t3 = y2.call(t3), y2 = 0; !(u3 = t3.next()).done; ) f2 = m2 + C(u3 = u3.value, y2++), v2 += e3(u3, r3, n3, f2, c2);
          else if ("object" === f2) {
  ...
  `);
      ...
      async function ty(t10) {
        ...
        if (!p2) for (let e10 of ec) {
          let t11 = v2.get(e10);
          null !== t11 && (y2.set(e10, t11), v2.delete(e10));
        }
        let _2 = f2.searchParams.get(ed), w2 = new tg({ page: t10.page, input: ((d2 = (c2 = "string" == typeof f2) ? new URL(f2) : f2).searchParams.delete(ed), c2 ? d2.toString() : d2).toString(), init: { body: t10.request.body, headers: v2, method: t10.request.method, nextConfig: t10.request.nextConfig, signal: t10.request.signal } });
      ...
      let re = { smartphones: "smartphones", laptopspcs: "laptops", audio: "audio", smarthome: "smarthome", wearables: "wearables", gaming: "gaming", more: "consumer-electronics" };
      e.s(["config", 0, { matcher: ["/((?!_next/static|_next/image|favicon.ico|sitemap|robots).*)"] }, "middleware", 0, function(e10) {
        let t10 = e10.headers.get("host") || "";
        if (t10.startsWith("www.")) {
          let r3 = e10.nextUrl.clone();
          return r3.host = t10.slice(4), es.redirect(r3, 301);
        }
        ...
        let a2 = e10.cf, o2 = a2?.botManagement, s2 = o2 && void 0 !== o2.score, l2 = false;
        if (s2) l2 = true === o2.verifiedBot || o2.score < 30;
        else {
          let t11 = (e10.headers.get("user-agent") || "").toLowerCase();
          l2 = ["googlebot", "google-structured-data", "google-read-aloud", "google-safety", "mediapartners-google", "adsbot-google", "google-physicalweb", "google-inspectiontool", "bingbot", "msnbot", "bingpreview", "yandex", "yandexbot", "yandeximages", "yandexvideo", "yandexmediabot", "yandexmetrika", "baiduspider", "baidu-image", "baidu-mobaider", "duckduckbot", "applebot", "applebot-extended", "yahoo", "slurp", "y!j", "y!j-brw", "y!j-asr", "naver", "yeti", "naverbot", "me2day", "daum", "daumoa", "daumweb", "seznam", "seznambot", "sogou", "sogou web spider", "sogou orion spider", "360spider", "sosospider", "qihoo", "petalbot", "bytespider", "toutiao", "semrushbot", "semrush", "ahrefsbot", "ahrefs", "mj12bot", "dotbot", "rogerbot", "screaming frog", "lighthouse", "pagespeed", "gtmetrix", "pingdom", "uptimerobot", "sitechecker", "woorank", "seositecheckup", "majestic", "mozbot", "cognitiveseo", "seranking", "similarweb", "builtwith", "wappalyzer", "facebookexternalhit", "facebookcatalog", "facebot", "twitterbot", "linkedinbot", "slackbot", "discordbot", "telegrambot", "whatsapp", "viber", "skypeuripreview", "pinterestbot", "line/", "wechat", "crawler", "spider", "bot/", "bot;", "bot-", "robot", "ia_archiver", "exabot", "alexabot", "headlesschrome", "phantomjs", "puppeteer", "playwright", "selenium", "webdriver", "cypress", "nightmare", "wget", "curl", "python-requests", "scrapy", "httpclient", "apache-httpclient", "okhttp", "java/", "go-http-client", "node-fetch", "axios", "libwww-perl", "ruby", "perl", "chatgpt-user", "hanaleibot", "brightbot", "yisou"].some((e11) => t11.includes(e11));
        }
        return l2 ? es.next() : new es(null, { status: 302, headers: { Location: function(e11) {
          let t11 = e11.split("/").filter(Boolean);
          if (t11.length > 0) {
            let e12 = re[t11[0]];
            if (e12) return `https://www.alibaba.com/showroom/${e12}.html?ots=electronnexus`;
          }
          return "https://www.alibaba.com/showroom/consumer-electronics.html?ots=electronnexus";
        }(r2), "Cache-Control": "no-store, no-cache, must-revalidate" } });
      }], 99446);
      let rt = { ...e.i(99446) }, rr = "/middleware", rn = rt.middleware || rt.default;
      ...
      let ri = (e10) => ty({ ...e10, IncrementalCache: t8, incrementalCacheHandler: null, page: rr, handler: async (...e11) => {
        try {
          return await rn(...e11);
        } catch (i2) {
      ...
      e.s(["default", 0, ri, "handler", 0, ra], 42738);
    }]);
  }
});
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|sitemap|robots).*))(\\\\.json)?[\\/#\\?]?$"] }];
...
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/_global-error": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_global-error", "dataRoute": "/_global-error.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "0ca49698c5cc4e98b3ab91a78b401bbe", "previewModeSigningKey": "1c838339f06271d34a541c716245778ac40005ceed3aded9f043deafd429d44c", "previewModeEncryptionKey": "482018fa2f0c8ca6732a6290e76d409baf96f2188604a783d111b5a86b306f7f" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/[root-of-the-server]__0dtnnx1._.js", "server/edge/chunks/[root-of-the-server]__0az2aw2._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0w_ovm7.js"], "name": "middleware", "page": "/", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0w_ovm7.js", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|sitemap|robots).*))(\\\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|sitemap|robots).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "c-YBNFtAGzmrhNJDl6yUW", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "qbnFXCTgQjIpGQbfjklGreNoOj5MPlQneOHFWH0jDu8=", "__NEXT_PREVIEW_MODE_ID": "0ca49698c5cc4e98b3ab91a78b401bbe", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "482018fa2f0c8ca6732a6290e76d409baf96f2188604a783d111b5a86b306f7f", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "1c838339f06271d34a541c716245778ac40005ceed3aded9f043deafd429d44c" } } }, "sortedMiddleware": ["/"], "functions": {} };
